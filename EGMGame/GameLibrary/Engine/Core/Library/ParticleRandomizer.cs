...
{
    public abstract class RandomizerBase : Random
    {
        #region Constructors

        public RandomizerBase() { }

        public RandomizerBase(int seed) : base(seed) { }
    ...
    public class QuickAlgorythm : RandomizerBase
    {
        #region Constructors

        public QuickAlgorythm() : this(Convert.ToInt32(DateTime.Now.Ticks & 0x000000007FFFFFFF)) { }

        public QuickAlgorythm(int seed)
            : base(seed)
        {
